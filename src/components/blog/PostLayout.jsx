...
export default function PostLayout({ data, next, prev }) {
  ...
  return (
    <div className='mx-auto max-w-4xl px-4 sm:px-6 xl:max-w-5xl xl:px-0'>
      <article>
        <div className='xl:dark:divide-gray-700 xl:divide-y xl:divide-gray-200'>
          ...
          <div
            className='dark:divide-gray-700 divide-y divide-gray-200 pb-8 xl:grid xl:grid-cols-4 xl:gap-x-6 xl:divide-y-0'
            style={{ gridTemplateRows: 'auto 1fr' }}
          >
            <dl className='xl:dark:border-gray-700 pt-6 pb-10 xl:border-b xl:border-gray-200 xl:pt-11'>
                ...
                <ul className='flex justify-center space-x-8 sm:space-x-12 xl:block xl:space-x-0 xl:space-y-8'>
                  <li className='flex items-center space-x-2'>
                    <dl className='whitespace-nowrap text-sm font-medium leading-5'>
                      ...
                      <dd className='dark:text-gray-100 text-gray-900'>
                        <div>
            ...
            <footer>
              <div className='dark:divide-gray-700 divide-gray-200 text-sm font-medium leading-5 xl:col-start-1 xl:row-start-2 xl:divide-y'>
